...
void AdS5xS5_var_post_init(char *pfile)
{
   ...
   a1=0; AMRD_real_param(pfile,"a1",&a1,1);
   a2=0; AMRD_real_param(pfile,"a2",&a2,1);
   b1=0; AMRD_real_param(pfile,"b1",&b1,1);
   b2=0; AMRD_real_param(pfile,"b2",&b2,1);
   b3=0; AMRD_real_param(pfile,"b3",&b3,1);
   b4=0; AMRD_real_param(pfile,"b4",&b4,1);
   b5=0; AMRD_real_param(pfile,"b5",&b5,1);
   b6=0; AMRD_real_param(pfile,"b6",&b6,1);
   b7=0; AMRD_real_param(pfile,"b7",&b7,1);
   b8=0; AMRD_real_param(pfile,"b8",&b8,1);
   b9=0; AMRD_real_param(pfile,"b9",&b9,1);
   b10=0; AMRD_real_param(pfile,"b10",&b10,1);
   b11=0; AMRD_real_param(pfile,"b11",&b11,1);
   b12=0; AMRD_real_param(pfile,"b12",&b12,1);

...
c----------------------------------------------------------------------
     ...
     &                  x,dt,chr,L,ex,Nx,i)
        ...
        real*8 tb_tx0,tb_xx0,ief_bh_r0,r0,r_h,x_h
!----------------------------------------------------------------------
...
!        end do
     ...
     &                  )/4
        ...
        ! set tbar values (NOTE: FOR EF)
        ief_bh_r0=0.5d0
        r0=ief_bh_r0
        r_h=L*sqrt(2*sqrt(1+4*(r0/L)**2)-2)/2
        x_h=r_h/(1+r_h)
        tb_tx0=(-4*(-1 + x0)**3*x0**2*(L**2*(-1 + x0)**2 + x0**2))/
     &  (L**2*(-x0**4 + L**2*(-1 + x0)**2*(r0**2*(-1 + x0)**2 - x0**2))*
     &    (-1 + x_h)**5)
        tb_xx0=(-4*(-1 + x0)**8*x0**4*(L**2*(-1 + x0)**2 + x0**2))/
     &  ((x0**4 - L**2*(-1 + x0)**2*(r0**2*(-1 + x0)**2 - x0**2))**2*
     &    (-1 + x_h)**10)

        ! correct t0_ll for non-horizon-penetrating coordinates (NOTE: FOR EF)
        t0_ll(1,2)=t0_ll(1,2)+tb_tx0
        t0_ll(2,1)=t0_ll(2,1)+tb_tx0
        t0_ll(2,2)=t0_ll(2,2)+tb_xx0

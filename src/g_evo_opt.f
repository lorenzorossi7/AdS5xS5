...
c----------------------------------------------------------------------
     ...
     &              +(dimA-1d0)
     &
     &              +gA*g0_u(1,1)*f1_l(1)*f1_l(1)/4
     &              +gA*g0_u(1,2)*f1_l(1)*f1_l(2)/4
     &              +gA*g0_u(1,3)*f1_l(1)*f1_l(3)/4
     &              +gA*g0_u(2,1)*f1_l(2)*f1_l(1)/4
     &              +gA*g0_u(2,2)*f1_l(2)*f1_l(2)/4
     &              +gA*g0_u(2,3)*f1_l(2)*f1_l(3)/4
     &              +gA*g0_u(3,1)*f1_l(3)*f1_l(1)/4
     &              +gA*g0_u(3,2)*f1_l(3)*f1_l(2)/4
     &              +gA*g0_u(3,3)*f1_l(3)*f1_l(3)/4
